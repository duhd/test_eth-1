...
const InboxABI = "[{\"constant\":false,\"inputs\":[{\"name\":\"initialMessage\",\"type\":\"string\"}],\"name\":\"doInbox\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"newMessage\",\"type\":\"string\"}],\"name\":\"setMessage\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"message\",\"outputs\":[{\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// InboxBin is the compiled bytecode used for deploying new contracts.
const InboxBin = ``
...
// DoInbox is a paid mutator transaction binding the contract method 0x032e6374.
//
// Solidity: function doInbox(string initialMessage) returns()
func (_Inbox *InboxTransactor) DoInbox(opts *bind.TransactOpts, initialMessage string) (*types.Transaction, error) {
	return _Inbox.contract.Transact(opts, "doInbox", initialMessage)
}

// DoInbox is a paid mutator transaction binding the contract method 0x032e6374.
//
// Solidity: function doInbox(string initialMessage) returns()
func (_Inbox *InboxSession) DoInbox(initialMessage string) (*types.Transaction, error) {
	return _Inbox.Contract.DoInbox(&_Inbox.TransactOpts, initialMessage)
}

// DoInbox is a paid mutator transaction binding the contract method 0x032e6374.
//
// Solidity: function doInbox(string initialMessage) returns()
func (_Inbox *InboxTransactorSession) DoInbox(initialMessage string) (*types.Transaction, error) {
	return _Inbox.Contract.DoInbox(&_Inbox.TransactOpts, initialMessage)
}
