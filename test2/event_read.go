...
func main(){
    	...
    	if err != nil {
			...
			from :=  []common.Address{common.HexToAddress("0xeb80964e1567064ba810b45300fd2ce3193d1684"),}
			to :=   []common.Address{common.HexToAddress("0xd95f832f5296037df962ad33da618cbf0a52e192"),}
