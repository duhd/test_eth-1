...
func main(){
	...
	tokenSymbol := "VND"
	initMasterKey1 := common.HexToAddress("0x3df3f699aa005ce3163dbdc6db1ecf07c90140f0")
	initMasterKey2 :=  common.HexToAddress("0x49a9b7b2f96778f144c99c6e23a9ed2011fcea8a")
